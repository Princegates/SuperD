  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        // Expanded, not a bare Column: the Row gives the text whatever is
        // left after the logo, instead of the text demanding whatever it
        // wants and overflowing the screen. "SuperDelivery" at this weight
        // is more than twice the width of the "SuperD" that used to sit
        // here, which was enough to push a 360dp phone over the edge.
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
